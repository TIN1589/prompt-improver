...
const PRESENCE_CHECKS = [
  ...
  ['prompt-improver-backend/worker.js', 'gemini-2.0-flash-lite'],
  ['prompt-improver-backend/worker.js', 'gemini-1.5-flash'],
  ['prompt-improver-backend/worker.js', 'extractRetryDelaySeconds'],
